...
def main1():
    ...
    parser1.add_argument('--seed', type=int, default=0, help='random seed')
    ...
    routines = {
        'common': [
            ...
            #{'func': construct_graph, 'args': (output_paths['cpnet']['csv'], output_paths['cpnet']['vocab'],
            #                                   output_paths['cpnet']['pruned-graph'], 0.3, False)},
        ...
        'csqa': [
            ...
            {'func': convert_to_entailment, 'args': (input_paths['csqa']['dev'], output_paths['csqa']['statement']['dev'], False, False)},
            ...
            #                          output_paths['cpnet']['patterns'], output_paths['csqa']['grounded']['dev'], 10)},
            ...
            #                              output_paths['cpnet']['pruned-graph'], output_paths['csqa']['paths']['raw-dev'], 10, args.seed)},
            ...
            #                               output_paths['cpnet']['vocab'], output_paths['csqa']['paths']['scores-dev'], 10)},
    ...
    #perturb_cpnet('./data/cpnet/conceptnet_2.en.pruned.graph', 16000, './data/cpnet/conceptnet.en.pruned.graph')
    for rt in args.run:
