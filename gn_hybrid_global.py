...
from modeling.modeling_gn_gen_evidence_hybrid_global_emb import *
...
def main():
    ...
    parser.add_argument('--num_layers', default=1, type=int, help='scale pretrained embeddings')
    # regularization
...
def train(args):
    ...
    model = LMGraphNet(model_name=args.encoder, concept_num=concept_num, concept_dim=relation_dim,
                          ...
                          pretrained_concept_emb=cp_emb, pretrained_relation_emb=rel_emb, freeze_ent_emb=args.freeze_ent_emb, num_layers = args.num_layers,
